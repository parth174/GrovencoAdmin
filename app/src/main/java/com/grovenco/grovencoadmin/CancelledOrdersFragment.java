...
public class CancelledOrdersFragment extends Fragment {
    ...
    private void getData() {
        ...
        FirebaseUtil.orders_ref.whereEqualTo("order_status_group","cancelled").orderBy("order_date_year", Query.Direction.DESCENDING).orderBy("order_time_formatted", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
